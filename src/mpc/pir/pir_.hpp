//#ifndef KUNLUN_PIR_HPP_
//#define KUNLUN_PIR_HPP_
//
//
...
//                           std::multiplies<uint64_t>()) > num_of_plaintexts) {
//                break;
//            }
//            dimensions[i] += 1;
//        }
...
//            throw std::invalid_argument("SEAL parameters not valid.");
//        }
//        if (!context.using_keyswitching()) {
//            throw std::invalid_argument("SEAL parameters do not support key switching.");
//        }
//        if (!context.first_context_data()->qualifiers().using_batching) {
//            throw std::invalid_argument("SEAL parameters do not support batching.");
//        }
//
//        BatchEncoder batch_encoder(context);
//        size_t slot_count = batch_encoder.slot_count();
//        if (slot_count != enc_params.poly_modulus_degree()) {
//            throw std::invalid_argument("Slot count not equal to poly modulus degree - this "
...
//        std::cout << "elements per BFV plaintext: " << pir_params.elements_per_plaintext
//            << std::endl;
//        std::cout << "dimensions for d-dimensional hyperrectangle: " << pir_params.d
//            << std::endl;
//        std::cout << "number of BFV plaintexts (before padding): "
//             << pir_params.num_of_plaintexts << std::endl;
...
//        std::cout << "Using recursive mod switching: " << pir_params.enable_mswitching
//             << std::endl;
...
//    std::uint64_t coefficients_per_element(uint32_t logt, uint64_t ele_size) {
...
//    }
//
//    GaloisKeys *deserialize_galoiskeys(std::string s, shared_ptr<SEALContext> context) {
