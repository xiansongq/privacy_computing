...
#include "../../src/frontend/include/WorkThread.h"
...
QT_MOC_LITERAL(3, 19, 7) // "setflag"

    },
    "WorkerThread\0done\0\0setflag"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::done)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WorkerThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::setflag)) {
                *result = 1;
                return;
            }
        }
